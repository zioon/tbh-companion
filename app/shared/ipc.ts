...
export const IPC = {
  ...
  ANALYZE_MARKET_VOLUME_BACKUP: "market:analyze-history-backup",
  ...
  GET_RECORD_LOG_PAGE: "get-record-log-page",
  GET_ACQUIRE_RING: "get-acquire-ring",
...
export const IPC_INVOKE_CHANNELS = [
  ...
  IPC.ANALYZE_MARKET_VOLUME_BACKUP,
  IPC.IMPORT_MARKET_VOLUME,
  IPC.GET_LIVE_MEMORY,
  IPC.GET_LIVE_MEMORY_STATUS,
  IPC.GET_STAGE_RUNS,
  IPC.GET_RECORD_LOG_PAGE,
  IPC.GET_ACQUIRE_RING,
  IPC.LOOT_RESET_BOX,
  IPC.LOOT_RESET_ALL,
