...
window.TBH_FLOW_VIZ = {
  ...
  "sourceFiles": [
    ...
    "docs/business-flows/00-architecture-and-dataflow.md",
    "docs/business-flows/01-startup-and-config.md",
    "docs/business-flows/02-save-decrypt-and-parse.md",
    "docs/business-flows/03-tracker.md",
    "docs/business-flows/04-live-memory.md",
    "docs/business-flows/05-inventory-and-lookup.md",
    "docs/business-flows/06-market.md",
    "docs/business-flows/07-catalog-refresh-and-session.md",
    "docs/business-flows/08-box-timer-and-stage-run.md",
  ...
  "flows": [
    {
      ...
      "title": "跨服务数据流总览",
      "anchor": "跨服务数据流总览",
      "source": "docs/BUSINESS-FLOWS.md",
      "sourceAnchor": "docs/BUSINESS-FLOWS.md#跨服务数据流总览",
      "diagrams": [
        {
          "label": "跨服务数据流总览",
          "subsection": null,
    ...
    },
    {
      ...
      "anchor": "关键错误处理路径汇总",
      "source": "docs/BUSINESS-FLOWS.md",
      "sourceAnchor": "docs/BUSINESS-FLOWS.md#关键错误处理路径汇总",
      "diagrams": []
    },
    {
      "number": 20,
      ...
      "anchor": "关键文件路径速查",
      "source": "docs/BUSINESS-FLOWS.md",
      "sourceAnchor": "docs/BUSINESS-FLOWS.md#关键文件路径速查",
      "diagrams": []
    },
    {
      "number": 21,
      ...
      "anchor": "文档维护约定",
      "source": "docs/BUSINESS-FLOWS.md",
      "sourceAnchor": "docs/BUSINESS-FLOWS.md#文档维护约定",
      "diagrams": []
    },
    {
      "number": 22,
      ...
      "anchor": "历史背景简要",
      "source": "docs/BUSINESS-FLOWS.md",
      "sourceAnchor": "docs/BUSINESS-FLOWS.md#历史背景简要",
      "diagrams": []
    },
    {
      "number": 0,
      "title": "项目目标与四层架构",
      "anchor": "项目目标与四层架构",
      "source": "docs/business-flows/00-architecture-and-dataflow.md",
      "sourceAnchor": "docs/business-flows/00-architecture-and-dataflow.md#项目目标与四层架构",
      "diagrams": [
        {
          "label": "数据流总览",
          "subsection": "数据流总览",
    ...
    },
    {
      ...
      "title": "启动流程",
      "anchor": "启动流程",
      "source": "docs/business-flows/01-startup-and-config.md",
      "sourceAnchor": "docs/business-flows/01-startup-and-config.md#启动流程",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/01-startup-and-config.md",
      "sourceAnchor": "docs/business-flows/01-startup-and-config.md#配置加载与-configpatch",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "title": "Save 解密与解析",
      "anchor": "save-解密与解析",
      "source": "docs/business-flows/02-save-decrypt-and-parse.md",
      "sourceAnchor": "docs/business-flows/02-save-decrypt-and-parse.md#save-解密与解析",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/03-tracker.md",
      "sourceAnchor": "docs/business-flows/03-tracker.md#tracker-双路径业务流程",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/04-live-memory.md",
      "sourceAnchor": "docs/business-flows/04-live-memory.md#livememory-业务流程",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/05-inventory-and-lookup.md",
      "sourceAnchor": "docs/business-flows/05-inventory-and-lookup.md#inventory-业务流程",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "anchor": "lookup-业务流程",
      "source": "docs/business-flows/05-inventory-and-lookup.md",
      "sourceAnchor": "docs/business-flows/05-inventory-and-lookup.md#lookup-业务流程",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "title": "Market 业务流程",
      "anchor": "market-业务流程",
      "source": "docs/business-flows/06-market.md",
      "sourceAnchor": "docs/business-flows/06-market.md#market-业务流程",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/07-catalog-refresh-and-session.md",
      "sourceAnchor": "docs/business-flows/07-catalog-refresh-and-session.md#catalog-refresh-业务流程",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/07-catalog-refresh-and-session.md",
      "sourceAnchor": "docs/business-flows/07-catalog-refresh-and-session.md#session-持久化appsrcmainservicessessionstateservicets",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/08-box-timer-and-stage-run.md",
      "sourceAnchor": "docs/business-flows/08-box-timer-and-stage-run.md#boxtimer-业务流程appsrcmainservicesboxtimerservicets",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/08-box-timer-and-stage-run.md",
      "sourceAnchor": "docs/business-flows/08-box-timer-and-stage-run.md#stagerun-业务流程appsrcmainservicesstagerunservicets-appsrccorestageruntrackerts",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/09-chest-and-autoclassify.md",
      "sourceAnchor": "docs/business-flows/09-chest-and-autoclassify.md#chestservice-业务流程appsrcmainserviceschestservicets",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/09-chest-and-autoclassify.md",
      "sourceAnchor": "docs/business-flows/09-chest-and-autoclassify.md#autoclassify-业务流程appsrcmainservicesautoclassifyservicets",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
        ...
        },
        {
          ...
          "nodes": [
            ...
            {
              "id": "Missed",
              "label": "延迟 5s 宽限 → flush 时先 claim 信用 → recordLiveChestDrop 补偿（不触发 BoxTimer）"
            },
            {
              "id": "Recalib",
            ...
            {
              "id": "Step1",
              "label": "Step1 excess-prune 队列数 > 槽位数 且 autoOpenAtMs 已到 → 移除最老"
            },
            {
              "id": "Step2",
            ...
            {
              "id": "Step5",
              "label": "Step5 漏掉掉落补偿 rare/act/plague*"
            },
            {
              "id": "Wait",
    ...
    },
    {
      ...
      "source": "docs/business-flows/10-notification-update-pet.md",
      "sourceAnchor": "docs/business-flows/10-notification-update-pet.md#notification-业务流程appsrcmainservicesnotificationservicets",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/10-notification-update-pet.md",
      "sourceAnchor": "docs/business-flows/10-notification-update-pet.md#update-业务流程appsrcmainservicesupdateservicets",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    },
    {
      ...
      "source": "docs/business-flows/10-notification-update-pet.md",
      "sourceAnchor": "docs/business-flows/10-notification-update-pet.md#pet-业务流程appsrcmainservicespetservicets-appsrccorepets",
      "diagrams": [
        {
          "label": "流程图",
          "subsection": "流程图",
    ...
    {
      "number": 24,
      "title": "开箱统计补齐（Box-Open Backfill）业务流程",
